    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("object_id", models.PositiveIntegerField(help_text="ID do item")),
                (
                    "quantity",
                    models.IntegerField(
                        default=1,
        ...
        migrations.AddIndex(
            model_name="coupon",
            index=models.Index(fields=["code"], name="orders_coup_code_ca5871_idx"),
        ),
        migrations.AddIndex(
            model_name="coupon",
            index=models.Index(
                fields=["is_active"], name="orders_coup_is_acti_9f0de3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="order",
        ...
        migrations.AddIndex(
            model_name="order",
            index=models.Index(
                fields=["delivered"], name="orders_orde_deliver_c4ad36_idx"
            ),
        ),
        migrations.AddIndex(
