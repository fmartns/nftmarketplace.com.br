...
urlpatterns = [
    ...
    path("billing/<str:billing_id>/status/", BillingStatusView.as_view(), name="billing-status"),
    path("billing/<str:billing_id>/pix/qrcode/", BillingPixQRCodeView.as_view(), name="billing-pix-qrcode"),
    path("billing/<str:billing_id>/pix/check/", BillingPixCheckView.as_view(), name="billing-pix-check"),
    path("billing/<str:billing_id>/simulate/", BillingSimulateView.as_view(), name="billing-simulate"),
