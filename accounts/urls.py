...
urlpatterns = [
    ...
    path("habbo/status/", views.HabboValidationStatusView.as_view(), name="habbo-validation-status"),
    path("habbo/history/", views.HabboValidationHistoryView.as_view(), name="habbo-validation-history"),
